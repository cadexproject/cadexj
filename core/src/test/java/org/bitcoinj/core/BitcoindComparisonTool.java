...
/**
 * A tool for comparing the blocks which are accepted/rejected by cadexd/cadexj
 * It is designed to run as a testnet-in-a-box network between a single cadexd node and cadexj
...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("USAGE: cadexjBlockStoreLocation runExpensiveTests(1/0) [port=18444]");
