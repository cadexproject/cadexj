    ...
    */
    ...
    class ThreadCheckDarkSendPool implements Runnable {
        ...
        public void run() {
            ...
            //RenameThread("cadex-darksend");
            log.info("--------------------------------------\nstarting cadex-darksend thread");
            int tick = 0;
            try {
    ...
    public boolean startBackgroundProcessing()
    {
        if(backgroundThread == null)
        {
            ...
            backgroundThread = new ContextPropagatingThreadFactory("cadex-privatesend").newThread(threadCheckDarkSendPool);
